    ...
    <main id="main">
      ...
      <center>
        ...
        echo'</thead>';
          ...
          $recup_suit = $bddGestion->query('SELECT * FROM `SUIVRE`');
          while(($Adhrts = $recup_Adhrts->fetch()) && ($suit = $recup_suit->fetch())){
            ...
            <th><a href='versement.php?num=".$suit['numOrdreSession']."&an=".$suit['anneSession']."&id=".$suit['adherent']."' class='btn btn-primary'>versement</a></th></tr>");
          }
          echo("</table>");
          ?>
      </section>
